...
<body>
    <div class="flex">
        <div class="sidebar lg:sticky z-[2] fixed top-0 lg:w-64 min-w-[256px] w-48 h-screen border-e whitespace-nowrap overflow-hidden"
            data-theme="light">
            <div class="flex items-center justify-between p-5 whitespace-nowrap">
            ...
            <div class="flex flex-col my-5 gap-2 p-5">
        ...
        <div class="w-full">
            <div class="navbar border-b z-[1] sticky top-0 flex items-center justify-between w-full h-12 p-5"
                data-theme="light">
                ...
                <div class="flex gap-3 me-3">
                    <div class="dropdown dropdown-bottom dropdown-end lg:block md:block hidden">
                        ...
                        <ul tabindex="0" class="dropdown-content z-[2] p-2 menu mt-7 shadow rounded-md w-72 border">
