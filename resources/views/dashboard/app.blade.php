...
<body>
    <div class="flex">
        <div class="sidebar z-20 lg:sticky fixed top-0 lg:w-64 min-w-[256px] w-48 p-5 h-screen border-e whitespace-nowrap overflow-hidden"
            data-theme="light">
            ...
            <div class="flex flex-col py-2 my-5 gap-2">
...
@yield('js.profile')
<script>
    jQuery('#mode').click(function(e) {
        jQuery('[data-theme]').each(function(index, x) {
