...
@section('home')
    ...
    <div class="shadow-slate-500 shadow rounded-md p-5 mb-5">
        <h2 class="font-inter text-xl mb-3 font-semibold">Paste Your URL To Shorten</h2>
        <form action="{{ route('short@store') }}" method="POST">
            @csrf
            <div class="join w-full border rounded-sm">
                <input type="text" name="url" class="w-full input-sm join-item p-1 px-2 outline-none" placeholder="https://example.com/">
                <button type="submit" name="submit" value="guest" class="btn btn-sm btn-info text-white join-item border ">Short</button>
            </div>
            @error('url')
            ...
            @if (session('data'))
                ...
                <div class="join w-full rounded-sm border">
                    <input type="text" value="{{ session('data') }}" class="input input-sm select-none join-item w-full" disabled>
        ...
        <div class="text-start mt-3">
            <h2 class="font-semibold text-lg">Premium Features</h2>
            <div class="grid lg:grid-cols-3 gap-1 my-3">
                <li>Dashboard</li>
                <li>Custom Link</li>
    ...
    <div class="text-start mb-10">
        <div class="mb-3">
            <h2 class="font-semibold">Simple and fast URL shortener!</h2>
        ...
        <div class="">
            <h2 class="font-semibold">Shorten, share and track</h2>
    ...
    <div class="grid lg:grid-cols-3 grid-cols-2 gap-10">
        @foreach ($source as $s)
            <div class="w-full">
                <img src="{{ asset('assets/images/') }}/{{ $s['image'] }}" alt="" class="w-12 mx-auto">
